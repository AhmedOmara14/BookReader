package tra.wor.bookreader.ui.fragment;
...
import tra.wor.bookreader.ui.programmingAdapter;
import tra.wor.bookreader.ui.sportsAdapter;
...
public class homefragment extends Fragment {
    ...
    @Inject
    Retrofit retrofit;
    tra.wor.bookreader.ui.sportsAdapter sportsAdapter;
    tra.wor.bookreader.ui.programmingAdapter programmingAdapter;
    Repositry repositry;
    ...
    private void getdataofprograming() {
        ((CustomApplication) getActivity().getApplicationContext()).getNetworkComponent().inject(homefragment.this);
        recProgramming.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        repositry.getitems("programming",retrofit).observe((LifecycleOwner) getContext(), new Observer<List<items>>() {
            @Override
